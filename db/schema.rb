...
ActiveRecord::Schema.define(:version => 20131023043815) do
  ...
  add_index "invoices", ["student_id"], :name => "index_invoices_on_student_id"
  ...
  add_index "logs", ["student_id"], :name => "index_logs_on_student_id"
  ...
  add_index "purchases", ["student_id"], :name => "index_purchases_on_student_id"
